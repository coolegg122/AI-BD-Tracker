...
const ProtectedRoute = ({ children }) => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen bg-ui-bg transition-colors duration-300">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-ui-accent"></div>
      </div>
    );
  }
